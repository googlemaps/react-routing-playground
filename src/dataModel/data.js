...
const algoOptions = [
  {
    enabled: true,
    value: "rp",
    label: "Routes Preferred - traffic unaware",
    numRoutes: 100,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_UNAWARE"),
  },
  {
    enabled: true,
    value: "rp_traffic_aware",
    label: "Route Preferred - traffic aware",
    numRoutes: 100,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_AWARE"),
  },
  {
    enabled: true,
    value: "rp_traffic_aware_optimal",
    label: "Route Preferred - traffic aware optimal",
    numRoutes: 100,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_AWARE_OPTIMAL"),
  },
  {
    enabled: true,
    value: "rp_bicycle",
    label: "Route Preferred - bicycle",
    numRoutes: 100,
    compute: async (pairs) => computeRoutesPreferred(pairs, "BICYCLE"),
  },
  {
    enabled: true,
    value: "rp_twowheeler",
    label: "Route Preferred - two wheeler",
    numRoutes: 100,
    compute: async (pairs) => computeRoutesPreferred(pairs, "TWO_WHEELER"),
  },
  {
    enabled: true,
    value: "rp_avoid_highway",
    label: "Route Preferred - avoid highway",
    numRoutes: 100,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_AWARE", {
        avoidHighways: true,
  ...
  {
    enabled: true,
    value: "rp_avoid_tolls",
    label: "Route Preferred - avoid tolls",
    numRoutes: 100,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_AWARE", {
        avoidTolls: true,
  ...
  {
    enabled: true,
    value: "rp_25_waypoints",
    label: "Route Preferred - 25 waypoints",
    numRoutes: 1,
    numWaypoints: 25,
    compute: async (pairs) =>
      computeRoutesPreferred(pairs, "DRIVE", "TRAFFIC_AWARE"),
  ...
  {
    enabled: true,
    value: "directions_25_waypoints",
    label: "Directions - 25 waypoints",
    numRoutes: 1,
    numWaypoints: 25,
    compute: async (pairs) => computeRoutesDirectionsJsSDK(pairs, "DRIVING"),
  },
  {
    enabled: true,
    value: "directions_25_waypoints_optimized",
    label: "Directions - 25 waypoints (optimized)",
    numRoutes: 1,
    numWaypoints: 25,
    compute: async (pairs) =>
      computeRoutesDirectionsJsSDK(pairs, "DRIVING", {
  ...
  {
    enabled: true,
    value: "directions_bicycle",
    label: "Directions - Bike",
    numRoutes: 15,
    compute: async (pairs) => computeRoutesDirectionsJsSDK(pairs, "BICYCLING"),
  },
  {
    enabled: true,
    value: "directions_avoid_highway",
    numRoutes: 15,
    label: "Directions - Avoid Highways",
    compute: async (pairs) =>
      computeRoutesDirectionsJsSDK(pairs, "DRIVING", { avoidHighways: true }),
  },
  {
    enabled: true,
    value: "directions_avoid_tolls",
    label: "Directions - Avoid Tolls",
    numRoutes: 15,
    compute: async (pairs) =>
      computeRoutesDirectionsJsSDK(pairs, "DRIVING", { avoidTolls: true }),
  },
];
